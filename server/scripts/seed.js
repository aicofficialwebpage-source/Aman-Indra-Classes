...
const seedData = async () => {
  try {
    ...
    await mongoose.connect(
      process.env.MONGODB_URI || "mongodb://127.0.0.1:27017/aman_indra_classes",
    );
    ...
    const defaultSettings = [
      { key: "heroHeadline", value: "Transform Potential Into Results" },
      {
        key: "heroSubheadline",
        value:
          "Kanpur's Trusted Coaching Institute for Classes 6–12, IIT-JEE & NEET Preparation Since 2014.",
      },
      {
        key: "heroImageUrl",
        value:
      ...
      { key: "heroTagline", value: "★ Kanpur's Premier Coaching Institute" },
      { key: "heroShowTopper", value: "true" },
      ...
      },
      {
        key: "workingHours",
        value:
          "Monday - Saturday: 11:00 AM - 8:00 PM | Sunday: 9:00 AM - 1:00 PM",
      },
      { key: "socialFacebook", value: "https://facebook.com/amanindraclasses" },
      {
        key: "socialInstagram",
        value: "https://instagram.com/amanindraclasses",
      },
      { key: "socialYoutube", value: "https://youtube.com/amanindraclasses" },
      {
        key: "googleMapEmbedUrl",
        value:
          "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d223.2685117185874!2d80.28700527479934!3d26.44618000000002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x399c47bda36740ef%3A0xdb53971ab28c86a!2sAman%20Indra%20Classes%20-%20Best%20PCM%20Coaching%20in%20Ratan%20Lal%20Nagar!5e0!3m2!1sen!2sin!4v1780909702425!5m2!1sen!2sin",
      },
      {
        key: "seoMetaTitle",
        value:
      ...
      },
      {
        ...
        value:
          "Aman Indra Classes (AIC) is Kanpur's premier institute for Class 6th-12th CBSE/ICSE boards, IIT-JEE, and NEET prep. Join Kanpur's toppers today!",
      },
      {
        key: "seoKeywords",
        value:
    ...
    const defaultTestimonials = [
      {
        ...
        review:
          "The individual attention given to my son Aarav was exceptional. Unlike large institutes, the teachers here know every student by name. His board scores (98.6%) reflect their dedication.",
        rating: 5,
        type: "Text",
        status: "Published",
        photo:
      ...
      },
      {
        ...
        review:
          "Aman Indra Classes completely changed the way I look at Physics. The customized sheet assignments and Sunday tests build immense speed and accuracy.",
        rating: 5,
        type: "Text",
        status: "Published",
        photo:
      ...
      },
      {
        ...
        review:
          "Aman Sir and Indrani maam hand-held Rohan during his low scores, giving him personal revisions. Truly grateful for helping him clear NEET!",
        rating: 5,
        type: "Video",
    ...
    const defaultNotices = [
      ...
      },
      {
        ...
        content:
          "Register for the offline scholarship test to win up to 100% tuition waiver. Syllabus: Class-appropriate Maths & Science concepts.",
      ...
      },
      {
        ...
        content:
          "Special target program with daily doubt solving and rigorous weekly mock test schedules commencing from next Monday.",
    ...
    const defaultBlogs = [
      {
        title:
          "How to Build a Strong Foundation for IIT-JEE starting from Class 9",
        slug: "jee-foundation-prep-class-9",
        excerpt:
          "An early start can multiply your chances of cracking the IIT JEE exam. Learn how to map your syllabus and master concepts from grade 9.",
        content: `
...
<p>Devote 2-3 hours daily outside school hours. Balance physics, chemistry, and maths equally. Take short revisions every Saturday.</p>
        ...
        metaDescription:
          "Step-by-step roadmap for high-school students to prepare early for IIT-JEE. Conceptual planning tips from expert faculty.",
        metaKeywords:
          "IIT-JEE Foundation, Class 9 JEE preparation, Kanpur Coaching classes, Aman Indra Classes",
      ...
      },
      {
        ...
        excerpt:
          "Chemistry is often the highest scoring subject in NEET. Read our expert tips on tackling Organic, Inorganic and Physical Chemistry with 100% accuracy.",
        content: `
...
<p>Build speed by practicing chemical equilibrium, thermodynamics, and electrochemistry. Practice at least 40 numericals daily.</p>
        ...
        metaDescription:
          "Master NEET Organic and Physical Chemistry sections. Learn tips from our BHU PhD chemist faculty.",
        metaKeywords:
          "NEET chemistry, organic chemistry tricks, best coaching Kanpur, Indrani Sen",
